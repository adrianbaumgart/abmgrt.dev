...
export default () => {
	return (
		<Page title="Privacy Policy" mainClass="indexSite">
			<div>
				<div className="privacypolicy">
					...
					<h2>Use of Data</h2>
					<p>
						Adrian Baumgart Website uses the collected data for various
						purposes:
					</p>
					<ul>
					...
					<p>
						Adrian Baumgart Website will take all steps reasonably necessary to
					...
					<p>
						Adrian Baumgart Website may disclose your Personal Data in the good
						faith belief that such action is necessary to:
					</p>
					<ul>
						<li>To comply with a legal obligation</li>
						<li>
							To protect and defend the rights or property of Adrian Baumgart
							Website
						</li>
						<li>
					...
					<ul>
						<li>
							...
							<p>Cloudflare Analytics is provided by Cloudflare, Inc.</p>
							<p>
								For more information on what type of information Cloudflare
					...
					<p>
						Our Service can be used by anyone under the age of 18 ("Children")
						too. Any service that collects personal data on this website do not
						address to Children.
					</p>
					<p>
