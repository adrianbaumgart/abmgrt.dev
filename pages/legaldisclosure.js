...
export default () => {
	...
	return (
		<Page title="Legal Disclosure" mainClass="indexSite">
			<div>
				<div className="legaldisclosure">
					<h1 className="sitetitle">Legal Disclosure</h1>
					<div>Information in accordance with Section 5 TMG</div>
					<p></p>
					<div>Adrian Baumgart</div>
					<div>Karl-Gehrig-Straße 2</div>
					<div>69226 Nussloch</div>
					<p></p>
